...
class MCDirector{
 ...
 threat(l,e){return e.hp>0&&!e.entering&&['idle','walk','phone','case','baton','enforcerJab','enforcerSlam','enforcerBurst','bossJab','bossSlam','bossBurst'].includes(e.action)&&(e.x-l.player.x)*l.player.face<-20&&Math.abs(e.x-l.player.x)<160&&Math.abs(e.y-l.player.y)<42&&l.enemyMode==='fight'}
